...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="//fonts.googleapis.com/css?family=Open+Sans:400i"/>
  <link rel="stylesheet" type="text/css" href="//fonts.googleapis.com/css?family=Open+Sans:700"/>
  <link rel="stylesheet" type="text/css" href="//fonts.googleapis.com/css?family=Open+Sans:700i"/>
...
<?php 
if ($_SERVER["REQUEST_URI"] == "/groups/cloudambassadors/node/1" || $_SERVER["REQUEST_URI"] == "/groups/cloudambassadors" || $_SERVER["REQUEST_URI"] == "/groups/cloudambassadors/") {
	$body_attributes = str_replace(" front","",$body_attributes);
